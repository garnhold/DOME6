...
namespace DOME
{
    public class DOMEVariableType_Multiple_RuleDefinition_ManualParent_LabeledItemSet : DOMEVariableType_Multiple_RuleDefinition_ManualParent
    {
        ...
        public DOMEVariableType_Multiple_RuleDefinition_ManualParent_LabeledItemSet(DOMEClass p, DOMEVariableTypeConcept t, DOMEVariableTypeConcept l) : base(p, t)
        {
