...
namespace DOME
{
    public class DOMEVariableType_Multiple_RuleDefinition_AutoParent_LabeledItemSet : DOMEVariableType_Multiple_RuleDefinition_AutoParent
    {
        ...
        public DOMEVariableType_Multiple_RuleDefinition_AutoParent_LabeledItemSet(DOMEClass p, DOMEVariableTypeConcept t, DOMEVariableTypeConcept l) : base(p, t)
        {
            label_type_concept = l;

            get_type_name = new OperationCache<string>(delegate() {
                return CSLine.Single("HoldingLabeledItemSet<?PARENT_TYPE, ?LABEL_TYPE, ?INNER_TYPE>",
